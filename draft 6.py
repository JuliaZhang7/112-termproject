...
def appStarted(app):
    ...
    app.board=Board((100,100),(400,400))
...
class Board(object):#the board to solve, hard coded
    def __init__(self,coordinate1,coordinate2):#both tuple
        self.cor1X=coordinate1[0]
        self.cor1Y=coordinate1[1]
        self.cor2X=coordinate2[0]
        self.cor2Y=coordinate2[1]
        self.boardR=13
        self.color1='pink'
        self.color2='pink'
...
def createBoard(app,coor1,coor2):
    app.board=Board(coor1,coor2)
def drawBoard(app,canvas):
    x1=app.board.cor1X
    y1=app.board.cor1Y
    r=app.board.boardR
    canvas.create_oval(x1-r,y1-r,x1+r,y1+r,fill='white',width=3)
    canvas.create_oval(x1-6,y1-6,x1+6,y1+6,fill=app.board.color1,width=3)
    x2=app.board.cor2X
    y2=app.board.cor2Y
    r=app.board.boardR
    canvas.create_oval(x2-r,y2-r,x2+r,y2+r,fill='white',width=3)
    canvas.create_oval(x2-6,y2-6,x2+6,y2+6,fill=app.board.color2,width=3)
